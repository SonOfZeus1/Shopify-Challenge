...
export default {
  ...
  data() {
    return {
      ...
      yourText:
        "Nominate up to 5 films that you think deserve a 2021 Shoppie.",
    };
  },
  mounted() {
  ...
  methods: {
    ...
    nominateMovie(e) {
      ...
      if (length == 4) {
        this.yourText =
          "You have nominated a maximum of 5 films for the 2021 Shoppie Awards. If you wish to change your nominations, remove one from your list and nominate another film.";
      }
